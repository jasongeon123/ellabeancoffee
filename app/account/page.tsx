...
export default async function AccountPage() {
  ...
  try {
    ...
    const userResult = await pool.query(
      `SELECT name, email, role, "loyaltyPoints", "createdAt" FROM "User" WHERE id = $1`,
      [userId]
    );
    ...
    const pointsResult = await pool.query(
      `SELECT * FROM "PointsHistory" WHERE "userId" = $1 ORDER BY "createdAt" DESC LIMIT 10`,
      [userId]
    );
    ...
    const pointsHistory = pointsResult.rows;
