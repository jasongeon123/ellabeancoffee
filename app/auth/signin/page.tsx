          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-coffee-500 font-light">Or continue with</span>
              </div>
            </div>
            ...
            <button
              ...
              type="button"
              className="mt-4 w-full flex justify-center items-center gap-3 py-3 px-4 border border-coffee-200 rounded-xl hover:bg-coffee-50 transition-all duration-200 hover:shadow-md"
            >
              ...
              <span className="text-coffee-900 font-light">Sign in with Google</span>
            </button>
          </div>
